...
$of_options[] = array( 	
						...
						"desc" 		=> "Ativa e desativa a exibição do Banner na home",
						"id" 		=> "banner_home",
						"std" 		=> 0,
						"on" 		=> "Enable",
						"off" 		=> "Disable",
...
//CSS e JS
$of_options[] = array( 	"name" 		=> "CSS e JS",
						"type" 		=> "heading",
						"icon"		=> ADMIN_IMAGES . "icon-home.png"
				);

$of_options[] = array( 	"name" 		=> "CSS personalizado",
						"desc" 		=> "You can use the following shortcodes in your footer text: [wp-link] [theme-link] [loginout-link] [blog-title] [blog-link] [the-year]",
						"id" 		=> "css_text",
						"std" 		=> "",
						"type" 		=> "textarea"
...
$of_options[] = array( 	"name" 		=> "JS personalizado",
						"desc" 		=> "You can use the following shortcodes in your footer text: [wp-link] [theme-link] [loginout-link] [blog-title] [blog-link] [the-year]",
						"id" 		=> "js_text",
						"std" 		=> "",
						"type" 		=> "textarea"
